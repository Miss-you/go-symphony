# T09 Final Implementation Plan V1: Codex App-Server Protocol
...
- `Session` owns the transport handle, thread id, workspace context, approval policy, sandbox policies, and timeout settings.
...
- Validate the workspace path before launch and reject invalid scope.
