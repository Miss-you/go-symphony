...
description: Use when a go-symphony task is already implemented, a GitHub PR exists or must be opened, and follow-up work is still needed because Copilot or other AI review comments may arrive after the initial PR push.
---
...
2. Keep periodic monitoring enabled.
   ...
   - Local or CI scan: `python3 scripts/pr_ai_review_monitor.py --repo <owner/name> [--pr <number>]`
...
| Scan all open PRs | `python3 scripts/pr_ai_review_monitor.py --repo Miss-you/go-symphony` |
| Scan one PR | `python3 scripts/pr_ai_review_monitor.py --repo Miss-you/go-symphony --pr 3` |
