...
| T03 | WORKFLOW Loader | Implement `WORKFLOW.md` parsing, template loading, hot reload, and last-known-good semantics. | T02 | P2 | todo | - | - | - | - | Loader behavior matches current semantics, including invalid reload fallback. | Gate: `go test ./internal/config/...` |
