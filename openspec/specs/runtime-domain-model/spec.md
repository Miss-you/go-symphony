...
Define the provider-neutral runtime vocabulary that later Go core packages use for work items, blockers, retries, polling, snapshots, and worker event reporting.
