...
Define the runtime runner execution-host contract for local command execution, SSH command execution, command result normalization, and stateless worker-host selection.
