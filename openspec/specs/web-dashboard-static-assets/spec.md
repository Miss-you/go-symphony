# Web Dashboard Static Assets Specification

## Purpose

Define the web observability dashboard compatibility surface for Go Symphony, including the root dashboard route, static asset routes, API delegation, configured runtime mounting, and projection-only rendering constraints.
