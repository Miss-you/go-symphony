...
Define the provider-neutral orchestrator runtime contract for polling, dispatch, retries, reconciliation, stall recovery, and snapshot projection in `internal/orchestrator`.
