...
Define operator-facing verification helpers for validating live Linear reads and a controlled single-item runtime smoke path without changing the production Symphony command behavior.
