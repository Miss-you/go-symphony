# CLI Bootstrap Parity Specification

## Purpose

Define the CLI/bootstrap compatibility surface for Go Symphony, including startup acknowledgement, workflow path parsing, log and port options, startup failure reporting, normal shutdown rendering, and parity-oriented verification evidence.
