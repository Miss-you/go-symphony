...
Define the normative `WORKFLOW.md` loader contract for the Go runtime so later config, workflow, and runtime tasks can build on a stable raw workflow source with source-faithful reload behavior.
